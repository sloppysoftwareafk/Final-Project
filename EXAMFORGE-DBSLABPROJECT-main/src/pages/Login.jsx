...
export default function Login({ onLogin, error }) {
  const [email, setEmail] = useState("instructor@test.com");
  ...
  return (
    <div className="dot-grid" style={{ minHeight: "100vh", display: "grid", placeItems: "center", padding: 20 }}>
      <div className="card glow fade-in" style={{ width: 420, padding: 28 }}>
        <h1 className="serif" style={{ fontSize: 32, marginBottom: 8 }}><span style={{ color: COLORS.accentSoft }}>exam</span>forge</h1>
        <p style={{ color: COLORS.textMuted, fontSize: 13, marginBottom: 18 }}>Online Multiple-Choice Test Management System</p>
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <p style={{ color: COLORS.textMuted, fontSize: 12, lineHeight: 1.6 }}>
            Demo users: instructor@test.com, contributor@test.com, student@test.com (password: password)
          </p>
        </div>
      </div>
    </div>
